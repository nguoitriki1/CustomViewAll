...
abstract class CalendarPagerAdapter<V extends CalendarPagerView> extends PagerAdapter {
  ...
  private Integer colorWeekDay = null;
  ...
  public CalendarPagerAdapter<?> migrateStateAndReturn(CalendarPagerAdapter<?> newAdapter) {
    ...
    newAdapter.colorWeekDay = colorWeekDay;
    newAdapter.typeFace = typeFace;
  ...
  public Object instantiateItem(@NonNull ViewGroup container, int position) {
    ...
    if (colorWeekDay != null) {
      pagerView.setWeekDayTextColor(colorWeekDay,typeFace,weekTextSize);
    }
  ...
  public void setColorWeekDay(int color,Typeface typeFace,Integer size) {
    this.colorWeekDay = color;
    this.typeFace = typeFace;
    this.weekTextSize = size;
    for (V pagerView : currentViews) {
      pagerView.setWeekDayTextColor(colorWeekDay,typeFace,size);
    }
  }
