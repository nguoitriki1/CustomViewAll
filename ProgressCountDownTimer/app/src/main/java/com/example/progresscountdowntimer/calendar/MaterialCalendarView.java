...
import com.example.progresscountdowntimer.calendar.format.ArrayWeekDayFormatter;
import com.example.progresscountdowntimer.calendar.format.DayFormatter;
import com.example.progresscountdowntimer.calendar.format.MonthArrayTitleFormatter;
import com.example.progresscountdowntimer.calendar.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  private int textWeekTitleColor = 0;
  private Integer textWeekTitleSize = null;
  private Typeface textWeekTypeFace = null;
  ...
  public MaterialCalendarView(Context context, AttributeSet attrs) {
    ...
    if (isInEditMode()) {
      ...
      monthView.setWeekDayTextColor(getWeekTextColor(),getWeekTextTypeFace(),getWeekTextSize());
  ...
  public int getWeekTextColor() {
    return textWeekTitleColor;
  }

  public int getWeekTextSize() {
    return textWeekTitleSize;
  }

  public Typeface getWeekTextTypeFace() {
    return textWeekTypeFace;
  }
  ...
  /**
   * @param color The WeekTitle color
   */
  public void setWeekTitleTextColor(Integer color,Typeface typeface,Integer size) {
    if (color == 0) {
      if (!isInEditMode()) {
        return;
      } else {
    ...
    textWeekTitleColor = color;
    adapter.setColorWeekDay(color,typeface,size);
    invalidate();
  }
  ...
  public void setHeaderTextStyle(Integer size,Typeface typeface,Integer colorHeaderText) {
    if (size != null){
    ...
    if (colorHeaderText != null){
      title.setTextColor(colorHeaderText);
    }
    invalidate();
  }
